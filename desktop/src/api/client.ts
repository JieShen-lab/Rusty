...
export const resolveChapterStyle = (id: number, value: { source_scope?: 'document' | 'chapter'; author_style_material_id?: number | null }) => trackAITask('确定写作风格', () => request<import('./types').ChapterStyleContext>(`/api/chapters/${id}/workflow/style/resolve`, body(value)));
